...
from notebooks_run.googleadk.agent_grammer import agent_grammar
from notebooks_run.googleadk.agent_maths import agent_math
from notebooks_run.googleadk.agent_summary import agent_summary
...
def send_query_to_agent(agent, query):
    ...
    runner = Runner(app_name=AGENT_APP_NAME, agent=agent, artifact_service=artifact_service,
...
if __name__ == '__main__':
    ...
    response = send_query_to_agent(agent_teaching_assistant,
