...
from notebooks_run.googleadk.agent_maths import agent_math
...
if __name__ == '__main__':
    ...
    """
    /Users/welcome/Desktop/Tech_Repos/adk-simple/.venv/bin/python /Users/welcome/Library/Mobile Documents/com~apple~CloudDocs/Sai_Workspace/Multi_agents_utils_V2/notebooks_run/googleadk/main_agent.py 
...
-----------------------------
Agent: agent_math
Response time: 2564.16 ms

Final Response:
The result of multiplying the numbers from 1 to 3 and then adding 4 is 10.
----------------------------------------------------------
